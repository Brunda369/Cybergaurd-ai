...
ALTER TABLE ONLY public.honeypot_events
    ADD CONSTRAINT honeypot_events_pkey PRIMARY KEY (id);
...
CREATE INDEX idx_honeypot_events_created_at ON public.honeypot_events USING btree (created_at DESC);
ALTER TABLE ONLY public.incidents
